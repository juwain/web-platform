...
Ранее уже разбирались <a href="/web-platform/trainers/design-patterns-js/04-singleton-theory">паттерн Singleton</a> (создание единственного в своём роде объекта) и <a href="/trainers/design-patterns-js/08-prototype-theory">паттерн Prototype</a> (создание объектов на основе общего шаблона). В обоих этих методах объекты создаются «вручную».
